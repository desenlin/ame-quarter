...
- **Frame:** navy/orange header, creator attribution, rounded white panels, navigation and footer match the FIN 355 tool family.
...
- DOM-emulation checks exercise all six selections, the native premise selector, rent-roll navigation, activity navigation, assumption changes, invalid input states, reset, exports, safe spreadsheet text, duplicate IDs and label associations.
